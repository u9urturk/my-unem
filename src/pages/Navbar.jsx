...
export default function Navbar() {
  return (
    <div className='w-full h-12 flex justify-between pl-12 pr-12 items-center bg-lime-600 pt-10'>
      ...
      <div className='flex justify-center  items-center   gap-x-3 font-semibold  text-sm  text-gray-100  '>
        <div>
